        ...
        if grad_step == self.cfgs.grad_steps_per_epoch - 1:
            self.logger.store(
                **{
                    ...
                    'Qr/data_Qr': qr1.mean().item(),
                    'Qr/target_Qr': qr_target.mean().item(),
                    'Qr/curr_Qr': qr_sample.mean().item(),
                    'Qr/rand_Qr': qr1_rand.mean().item(),

                    'Uncertainty/data_uncertainty': uncertainty.mean().item(),
                    'Uncertainty/target_uncertainty': uncertainty_next.mean().item(),
                    'Uncertainty/curr_uncertainty': uncertainty_ood_curr.mean().item(),
                    'Uncertainty/rand_uncertainty': uncertainty_rand.mean().item(),
